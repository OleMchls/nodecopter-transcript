...
command_map =
  ...
  'higher|up|raise': 'up'
  'lower|down': 'down'
  'leftflip|left-flip': 'animate flipLeft'
  'rightflip|right-flip': 'animate flipRight'
  'red': 'animateLeds red'
  'green': 'animateLeds green'
  'blink[\\-\\s]green': 'animateLeds blinkGreen'
  'blink[\\-\\s]red': 'animateLeds blinkRed'
